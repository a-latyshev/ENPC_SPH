...
Pour réaliser cette fonctionnalité on a implémenté des variables de type des particules et la fonction \lstinline$src\solver\particle_type$, qui retourne une liste de deux éléments : la valeur propre minimale et le type de la particule considérée.
